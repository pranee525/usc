...
namespace Tests.ControllerTests
{
    public class SyncControllerTests
    {
        ...
        public void GetBookings_200()
        {
            ...
            Booking booking1 = testEnvironment.AddBooking(evnt: evnt, customer: customer,custNote:"This is to test bookings");
            Booking booking2 = testEnvironment.AddBooking(evnt: evnt, customer: customer, custNote: "This is to test bookings");
            Booking booking3 = testEnvironment.AddBooking(evnt: evnt, customer: customer, custNote: "This is to test bookings");
